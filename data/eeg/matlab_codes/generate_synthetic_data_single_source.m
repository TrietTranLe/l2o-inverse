...
% july 2023
% single source dataset simulation -> nov 2024.
...
dataset_name = 'ses_nmm_fsav994_test';
clip_folder = "nmm_spikes_nov23_test"; % which spike data to use
...
% load anatomy data
load(strcat(home_dir, ...
    '/Documents/Data/simulation/fsav_994/constrained/standard_1020/fsav_994/model/anatomy/', 'fs_cortex_20k_inflated.mat') ); 
load(strcat(home_dir,...
    '/Documents/Data/simulation/fsav_994/constrained/standard_1020/fsav_994/model/anatomy/','fs_cortex_20k.mat') );
load(strcat(home_dir, ...
    '/Documents/Data/simulation/fsav_994/constrained/standard_1020/fsav_994/model/anatomy/','fs_cortex_20k_region_mapping.mat') );
...
load( strcat(home_dir, ...
    '/Documents/Data/simulation/fsav_994/constrained/standard_1020/fsav_994/model/anatomy/','LF_fsav_994.mat') );
fwd = G;
...
all_dis = load( strcat(home_dir, ...
    '/Documents/Data/simulation/fsav_994/constrained/standard_1020/fsav_994/model/anatomy/','dis_matrix_fs_20k.mat') ).raw_dis_matrix; %ajouté à la main
